...
```sh
  cd your-folder
  git clone https://github.com/iamchristianani/school-library.git
```
...
Feel free to check the [issues page](https://github.com/iamchristianani/school-library/issues).
